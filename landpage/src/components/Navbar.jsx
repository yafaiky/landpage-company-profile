        ...
        <nav className="flex flex-col">
          {links.map((link, i) => (
            <div key={link.label} className="group/item overflow-hidden">
              ...
              >
                <span className="text-4xl md:text-7xl font-bold tracking-tighter text-black group-hover:text-[var(--accent)] group-hover:translate-x-4 transition-all duration-500">
                  {link.label}
                </span>
                <span className="text-2xl md:text-4xl text-black/10 group-hover:text-[var(--accent)] transition-colors duration-300">
                  ↗
                </span>
              </button>
            </div>
