...
export default function Clients() {
  ...
  return (
    <main className="pt-24 md:pt-32 bg-[var(--bg)] min-h-screen">
      ...
      {/* CTA */}
      <section className="py-24 md:py-32 bg-[var(--bg-subtle)] text-center relative overflow-hidden border-t border-[var(--dimmer)]">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-[-0.03em] text-black mb-10 max-w-3xl mx-auto leading-tight">
            Lorem ipsum dolor sit amet <span className="text-[var(--accent)]">Lorem ipsum dolor sit amet.</span>
          </h2>
          <a
